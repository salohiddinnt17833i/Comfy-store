    ...
    <header className=''>
      <div className='header-top bg-neutral'>
        <div className='w-3/5 mx-auto py-2 flex gap-5 justify-end'>
          {
            log ? <button onClick={handleLogout} className='text-sm text-slate-300 hover:underline capitalize'>Log out</button> : <><Link to='/login' className='text-sm text-slate-300 hover:underline'>
              Sign in/ Guest
            </Link>
              <Link
                to='/register'
              ...
              <Link to='/cart'>
                ...
                >
                  <div className='indicator'>
                    ...
                    <span className={`badge badge-sm indicator-item ${theme.theme == 'light' ? 'badge-primary' : 'badge-secondary'}`}>
                      {allData.length}
                    </span>
                  </div>
                </div>
